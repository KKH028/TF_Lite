...
def detect(opt):
    ...
    if isinstance(weights, str): # Assuming that the weights parameter is used as a default value, the weights type is str.
      weights = weights
    else : # otherwise it is of type list
      weights = weights[0]  
